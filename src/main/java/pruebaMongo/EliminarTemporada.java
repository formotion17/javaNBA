...
public class EliminarTemporada extends BaseController{
	...
	public static void main(String[] args) throws UnknownHostException {
		...
		if(mongo!=null) {
			...
			for(Temporadas season:Temporadas.values()) {
				MongoCollection<Document> collection = db.getCollection("partido");
				
				for(int i=2000 ;i<2020;i++) {
					System.out.println("Recojemos el a�o: "+i);
...
//					seasonEliminar.put("mes", "2");
					...
					System.out.println("FINALIZAMOS el a�o: "+i);
				}
				
			}
			
			System.out.println("FINALIZAMOS TODOS LOS A�OS");
		}
	}

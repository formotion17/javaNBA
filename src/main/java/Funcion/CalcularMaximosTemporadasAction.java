...
public class CalcularMaximosTemporadasAction extends BaseController{
	...
	public static void main(String[] args) throws UnknownHostException {
		...
		if(mongo!=null) {
				...
				DB db = mongo.getDB(BASE_DATOS_NBA);
				DBCursor cursor;
				
				DBCollection collection =db.getCollection(COLECCION_TOTALES);
                ...
                obj.add(new BasicDBObject(ATRIBUTO_TEMPORADA, temporada));
                obj.add(new BasicDBObject(ATRIBUTO_TIEMPO, ATRIBUTO_REGULAR));
                obj.add(new BasicDBObject(ATRIBUTO_TIPO_RESULTADO, TIPO_RESULTADO_TOTAL));
